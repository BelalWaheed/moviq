...
const AllReviewsSeries = () => {
    ...
    return (
        <section className="my-10 px-4 container mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-8 ml-2 md:ml-6">
            ...
            <motion.div
                className="grid grid-cols-2 md:grid-cols-2 gap-6 w-full md:w-11/12 lg:w-10/12 mx-auto"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
                variants={{
                ...
                {reviews.map(review => (
                    <motion.div
                        key={review.id}
                        className="bg-black/90 border border-neutral-800 rounded-2xl p-5 flex flex-col shadow-lg hover:shadow-red-900/30 transition-shadow duration-300"
                        variants={{
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer">
                                    <h3 className="text-white font-semibold hover:text-blue-600 transition-colors">
                                        {review.author_details.name ||
                                            review.author}
                                    </h3>
                                </a>
                        ...
                        {/* Content */}
                        <div className="text-gray-300 text-sm leading-relaxed mb-3 max-h-32 overflow-y-auto pr-2 scroll-smooth">
                            {review.content}
                        </div>
