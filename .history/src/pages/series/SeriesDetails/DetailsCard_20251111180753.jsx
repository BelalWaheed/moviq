                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                className="flex items-center gap-4 px-3 py-2 bg-black/30 backdrop-blur-md rounded-2xl">
                                {/* Favourite */}
                                <motion.button
                                    whileHover={{ scale: 1.15 }}
                                    whileTap={{ scale: 0.9 }}
                                    // onClick={onFavourite}
                                    className={`p-2 rounded-xl transition-all duration-200 ${"text-red-500"}`}>
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.9 }}
                                    // onClick={onWishlist}
                                    className={`p-2 rounded-xl transition-all duration-200 ${"text-yellow-400"}`}>
