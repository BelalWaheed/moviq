                ...
                if (isRatedSeriesExist) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            if (exitSeries && exitSeries.rating == value) {
                                Swal.fire({
                                    icon: "info",
                                ...
                                dispatch(
                                    ...
                                    // بعد نجاح الإرسال، حدث الداتا عشان المرات الجاية تكون صحيحة
                                    dispatch(
                                        GetRatedSeries({
                                            accountId: AccountInfoDetails?.id,
                                            sessionId:
                                        ...
                                        if (updated) setExitSeries(updated);
                                    });
                                });
