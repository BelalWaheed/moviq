                ...
                <>
                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <button
                                // onClick={onOpen}
                                className="flex items-center gap-2 bg-black/20 hover:bg-black/40 transition shadow-md px-4 py-2 rounded-xl border border-red-600 hover:shadow-red-500/20">
