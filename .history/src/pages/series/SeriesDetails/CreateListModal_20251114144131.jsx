                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-white/[0.02] border border-white/10 rounded-2xl text-white placeholder-gray-600 focus:outline-none focus:border-white/20 transition-colors text-sm"
                        />
                    </div>
