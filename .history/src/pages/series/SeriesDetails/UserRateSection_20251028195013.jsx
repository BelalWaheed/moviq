...
const UserRateSection = () => {
    ...
    return (
        <div className="flex items-center gap-3 bg-black/90 px-4 py-3 rounded-2xl border border-gray-900 w-fit shadow-md hover:shadow-lg transition-all duration-200">
            ...
            {/* Clean numeric input without default background/spinners */}
            <input
                type="number"
                step="0.5"
                min="0"
                ...
                className="w-16 h-9 text-white text-center text-sm rounded-lg border border-gray-900 outline-none bg-transparent appearance-none transition-all focus:border-red-500 
            ...
            <Typography
                ...
                title="Use arrows to change rate">
