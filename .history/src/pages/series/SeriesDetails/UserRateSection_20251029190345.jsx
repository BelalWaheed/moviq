...
const UserRateSection = () => {
    ...
    const [isSeriesExist, setIsSeriesExist] = useState(false);
    ...
    useEffect(() => {
        ...
        const ratedSeriesExist = RatedSeriesDetails?.results?.some(series => {
            return series.id == localStorage.getItem("seriesId");
        });
        setIsSeriesExist(ratedSeriesExist);
        console.log(isSeriesExist);
    }, [localStorage.getItem("seriesId"), isSeriesExist]);
