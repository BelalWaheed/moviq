...
const UserRateSection = () => {
    ...
    }, [RatedSeriesDetails?.total_pages]);
    ...
    useEffect(() => {
        if (RatedSeriesDetails?.results) {
            ...
            console.log(
                `results: ${RatedSeriesDetails?.results}`,
                `page number: ${RatedSeriesDetails?.page}``isRatedSeriesExist: ${isRatedSeriesExist}`
            );
