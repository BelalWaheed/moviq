        ...
        <section className="my-10 px-4 w-full max-w-7xl mx-auto">
            ...
            <div className="flex justify-center items-center gap-3 mt-10">
                ...
                <button
                    ...
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-neutral-900 text-gray-300 hover:bg-red-600 hover:text-white transition-all duration-300 shadow-md">
                    ←
                </button>
                ...
                <div className="flex items-center gap-2">
                    {[1, 2, 3, 4, 5].map(num => (
                        <button
                            key={num}
                            className={`w-9 h-9 rounded-full font-medium transition-all duration-300 ${
                                num === 1
                                    ? "bg-red-600 text-white shadow-md scale-105"
                                    : "bg-neutral-900 text-gray-300 hover:bg-red-500 hover:text-white"
                            }`}>
                            {num}
                        </button>
                    ))}
