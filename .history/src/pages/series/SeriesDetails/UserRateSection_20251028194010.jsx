...
const UserRateSection = () => {
    ...
    return (
        <div className="flex items-center gap-3 bg-[#0f0f0f] px-4 py-3 rounded-2xl border border-gray-800 w-fit shadow-md hover:shadow-lg transition-all duration-200">
