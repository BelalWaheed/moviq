...
import { GetCheckItemStatus } from "../../../redux/SharedSlices/GetRequest/CheckItemStatus";
...
const ListsModal = ({ lists, onClose, onCreate, openLists, setOpenLists }) => {
    ...
    const { itemStatusDetails } = useSelector(
        state => state.getCheckItemStatusReducer
    );
    const { AccountInfoDetails, isLogged } = useSelector(
        state => state.AccountInfoSliceReducer
    );

    console.log(itemStatusDetails);
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        dispatch(
                                            ...
                                            if (currentList) {
                                                if (
                                                    itemStatusDetails?.item_present
                                                ) {
                                                    Swal.fire({
                                                        theme: "dark",
                                                        icon: "error",
                                        ...
                                        // const isModalExist =
                                        //     userListDetails?.results.some(
                                        //         exist => exist.id == list.id
                                        //     );
                                    }}
