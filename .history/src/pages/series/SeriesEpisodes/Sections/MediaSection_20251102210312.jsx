...
const MediaSection = () => {
    ...
    const getImageStyle = (width, height, type) => {
        ...
        else if (type === "stills") maxHeight = 160; // كان 300
            ...
            <div className="flex overflow-x-auto overflow-y-hidden gap-4 pb-2 scroll-indicator">
                ...
                {activeTab === "videos" && (
                    <>
                        ...
                        ) : SeriesEpisodesVideos?.results?.length === 0 ? (
    ...
    ">
                        ...
                        {SeriesEpisodesVideos?.results?.length > 10 && (
                            <button
                                onClick={() => navigate("/AllEpisodesVideos")}
                                ...
                                <span className="text-white text-lg font-bold">
                                    +{SeriesEpisodesVideos?.results?.length - 5}
                                </span>
                ...
                {activeTab === "stills" && (
                    <>
                        ...
                        {SeriesEpisodesImages?.stills?.length > 10 && (
                            <button
                                onClick={() => navigate("/StillsEpisodesPage")}
                                className="min-w-[150px] flex flex-col justify-center items-center bg-zinc-800 rounded-2xl cursor-pointer hover:scale-105 hover:bg-red-600 transition-all duration-300">
                                <span className="text-white text-lg font-bold">
                                    +{SeriesEpisodesImages?.stills?.length - 10}
                                </span>
