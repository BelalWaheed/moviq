...
const CastSection = () => {
    const {
        ...
        GetSeriesEpisodesCreditsLoading,
        GetSeriesEpisodesCreditsError
                    ...
                    {GetSeriesEpisodesCredits?.cast?.length > 0 && (
                        <section className="max-w-6xl mx-auto px-6 pb-20">
                            ...
                            <div className="flex gap-4 overflow-x-auto overflow-y-hidden scroll-indicator pb-3">
                                ...
                                {GetSeriesEpisodesCredits.cast.length > 10 && (
                                    <button
                                        onClick={() =>
