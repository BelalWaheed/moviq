...
function Series() {
    ...
    useEffect(() => {
        if (RequestSingInDetails?.success) {
            console.log("TOKEN:", RequestSingInDetails.request_token);
            window.location.href = `https://www.themoviedb.org/authenticate/${RequestSingInDetails.request_token}?redirect_to=http://localhost:3000/auth/callback`;
        }
