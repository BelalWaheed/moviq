    ...
    return (
        <section className="max-w-6xl mx-auto px-6 pb-20">
            ...
            <div className="flex gap-4 scroll-indicator overflow-x-auto overflow-y-hidden pb-4">
                        ...
                        onClick={() => {
                            dispatch(
                                GetSeriesEpisodesDetails({
                                    seriesId: ep?.episodes?.show_id,
                                    seasonNumber: ep?.episodes?.season_number,
                                    episodeNumber: ep?.episodes?.episode_number
                                })
                            );
                        }}
                        key={ep.id}
                ...
                bg-[#0f0f0f] rounded-2xl overflow-hidden shadow-lg border border-gray-800
            ">
