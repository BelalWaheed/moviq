...
export default function SearchPage() {
  ...
  const { searchResults, isSearching, searchQuery } = useSelector(
    (s) => s.searchReducer
  );
  ...
  // ✅ When query in URL changes, update Redux searchQuery (so input reflects it)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background-primary px-4 sm:px-8 pt-24">
      ...
      >
        Search results for{" "}
        <span className="text-accent-primary">"{searchQuery}"</span>
      </motion.h1>
