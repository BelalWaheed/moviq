...
const CastSeriesPersonCombinedCredits = ({ PersonDetailsname }) => {
    const {
    ...
    return (
        <section className="max-w-6xl mx-auto px-6 pb-20">
            <h2 className="text-2xl font-medium mb-6 text-red-500">
                Series in which{" "}
                <span className="font-bold">{PersonDetailsname}</span> acted
            </h2>
                ...
                {personCombinedCreditsDetailsLoading ? (
                    ...
                    <>
                        ...
                        {uniqueSeries.length > 10 && (
                            <button
                                onClick={() => navigate(`/person/${personId}/series/cast`)}
...
export default CastSeriesPersonCombinedCredits;
