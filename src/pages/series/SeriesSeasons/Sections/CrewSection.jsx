...
const CrewSection = () => {
    ...
    const uniqueCrew = useMemo(() => {
        if (!seasonsAggregateCreditsDetails?.crew) return [];
        const seen = new Set();
        return seasonsAggregateCreditsDetails.crew.filter((worker) => {
        ...
        >
            <div className="flex gap-4 overflow-x-auto overflow-y-hidden scroll-indicator pb-3">
                    ...
                    <div
                        ...
                        <div className="p-2">
                            ...
                            <p className="text-gray-400 text-xs truncate">
                                {worker.department || "Unknown Role"}
                            </p>
                        </div>
                    </div>
                ))}
                ...
                {uniqueCrew.length > 10 && (
                    <button
                        onClick={() => navigate(`/series/${seriesId}/season/${seasonNumber}/crew`)}
