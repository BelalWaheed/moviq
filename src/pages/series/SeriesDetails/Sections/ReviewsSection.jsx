...
const ReviewsSection = () => {
    const { SeriesReviewsDetails, SeriesReviewsLoading } = useSelector(
                ...
                {!showReviews ? (
                    ...
                    <>
                        {SeriesReviewsLoading ? (
                            ...
                            <div className="ml-6 text-gray-400">No reviews found for this series.</div>
                        ) : (
                            <>
                                <motion.div
                                ...
                                {reviews.length > 5 && (
                                    <div className="flex justify-center mt-6 w-full">
                                        <button
                                            ...
                                            Show {SeriesReviewsDetails?.total_results - 3}+
                                            reviews
                                        </button>
                                    </div>
                                )}
